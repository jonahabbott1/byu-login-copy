...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).cssVars =
        t())
})(this, function () {
  "use strict"
  function e() {
        ...
        o.open("GET", e),
          ...
          (o.onreadystatechange = function () {
            if (4 === o.readyState) {
              ...
              ;(o.status < 400 && s(e)) || (0 === o.status && s(e))
                ? c(e, t)
                : a(o, t)
            }
          }),
  ...
  function r(e) {
    var r = /\/\*[\s\S]+?\*\//g,
      ...
      a = Array.apply(null, s.rootElement.querySelectorAll(s.include)).filter(
        function (e) {
          return (
            (t = e),
            (r = s.exclude),
      ...
      ? a.forEach(function (e, r) {
          var o = e.getAttribute("href"),
            ...
            l =
              ...
              o &&
              a &&
              -1 !== a.toLowerCase().indexOf("stylesheet"),
  ...
  function i(t) {
    ...
    function b() {
      if (i(/^@page */))
        return { type: "page", selectors: m() || [], declarations: h() }
    }
    function S() {
      var e = i(
      ...
      if (e)
        return {
          ...
          name:
            "".concat(e[1], "-").concat(e[2]) + (e[3] ? "-".concat(e[3]) : ""),
          declarations: h(),
        }
    }
    function E() {
    ...
    function C() {
      if (i(/^@host\s*/)) return { type: "host", rules: V() }
    }
    function x() {
      var e = i(/^@media([^{]+)*/)
    ...
    function O() {
      ...
      if (e)
        return { type: "custom-media", name: e[1].trim(), media: e[2].trim() }
    }
    function A() {
      var e = i(/^@([-\w]+)?document *([^{]+)/)
      if (e)
    ...
    function j() {
      ...
      return (
        a.length || c("selector missing"),
        { type: "rule", selectors: a, declarations: i }
      )
    }
    function V(e) {
      ...
      for (
        var r, n = p();
        t.length && (e || "}" !== t[0]) && (r = _() || j());

      )
        r.type && n.push(r), (n = n.concat(p()))
      return e || l() ? n : c("missing '}'")
    }
    return { type: "stylesheet", stylesheet: { rules: V(!0), errors: a } }
  }
  function u(t) {
    var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            if (o.preserveVars || !a || 0 !== a.indexOf("--")) {
              if (-1 !== c.indexOf("var(")) {
                ...
                i !== n.value &&
                  ((i = p(i)),
                  o.preserveVars
                    ? (e.splice(r, 0, { type: s, property: a, value: i }), r++)
                    : (n.value = i))
              }
            } else e.splice(r, 1), r--
        }
  ...
  function m(e) {
    ...
    function s(e) {
      var n = e.split(",")[0].replace(/[\s\n\t]/g, ""),
        o = (e.match(/(?:\s*,\s*){1}(.*)?/) || [])[1],
        s = Object.prototype.hasOwnProperty.call(t.variables, n)
          ? String(t.variables[n])
          : void 0,
        a = s || (o ? String(o) : void 0),
        c = r || e
      return (
        s || t.onWarning('variable "'.concat(n, '" is undefined')),
    ...
    if (n) {
      if ("var" === n.pre.slice(-3)) {
        ...
        return a
          ...
          : n.pre.slice(0, -3) + s(n.body) + m(n.post, t)
      }
  ...
  var v = "undefined" != typeof window,
    h =
      v && window.CSS && window.CSS.supports && window.CSS.supports("(--a: 0)"),
    g = { group: 0, job: 0 },
    y = {
  ...
  function A() {
    ...
    if (v) {
      ...
      if (
        (!1 === o.watch && w && (w.disconnect(), (w = null)), !o.__benchmark)
      ) {
        if (E === o.rootElement) return void _(t)
        var f = [].slice.call(
          o.rootElement.querySelectorAll(
        ...
        if (
          ...
          var p = [].slice.call(
            o.rootElement.querySelectorAll('[data-cssvars="out"]')
          )
          p.forEach(function (e) {
            var t = e.getAttribute("data-cssvars-group")
            ;(t
              ? o.rootElement.querySelector(
                  '[data-cssvars="src"][data-cssvars-group="'.concat(t, '"]')
                )
            ...
            ? r({
                ...
                onSuccess: function (e, t, r) {
                  return (
                    ...
                    ((e = (
                      (e = e
                        .replace(b.cssComments, "")
                        .replace(b.cssMediaQueries, "")).match(
                        b.cssVarDeclRules
                      ) || []
                    ).join("")) ||
                      !1)
              ...
              r({
                ...
                onSuccess: function (e, t, r) {
                  ...
                  var n = "link" === t.nodeName.toLowerCase(),
                    ...
                    a = o.onSuccess(e, t, r)
                  return (
                    (e = void 0 !== a && !1 === Boolean(a) ? "" : a || e),
                    o.updateURLs && (n || s) && (e = V(e, r)),
                    e
                  )
                },
                onComplete: function (t, r) {
                  ...
                  if (
                    ...
                    e(S.job, S.dom),
                    o.updateDOM
                      ? (e(S.user, o.variables), e(S.job, S.user))
                      : (e(S.job, S.user, o.variables), e(f, o.variables)),
                    g.job > 0 &&
                      Boolean(
                    ...
                    if (
                      ...
                      n.forEach(function (t, n) {
                        ...
                        if (t.__cssVars.tree)
                          try {
                            d(
                              t.__cssVars.tree,
                              e({}, o, { variables: S.job, onWarning: a })
                            )
                              ...
                              if (
                                ...
                                ;(v = v || b.cssKeyframes.test(i)),
                                  ...
                                  E.hasAttribute("data-cssvars") ||
                                    E.setAttribute("data-cssvars", "out"),
                        ...
                        c && t.setAttribute("data-cssvars", "skip"),
                          t.hasAttribute("data-cssvars-job") ||
                            t.setAttribute("data-cssvars-job", g.job)
                      }),
                      (C = o.rootElement.querySelectorAll(
                        '[data-cssvars]:not([data-cssvars="out"])'
                      ).length),
                      o.shadowDOM)
                    )
                      for (
                        var h,
                          y = []
                            .concat(o.rootElement)
                            .concat(
                              [].slice.call(o.rootElement.querySelectorAll("*"))
                            ),
                          w = 0;
                        (h = y[w]);
                        ++w
                        ...
                        if (
                          h.shadowRoot &&
                          h.shadowRoot.querySelector("style")
                        ) {
                    ...
                    o.updateDOM && v && j(o.rootElement),
                      ...
                      o.onComplete(
                        p.join(""),
                        m,
                        JSON.parse(JSON.stringify(S.job)),
                        T() - o.__benchmark
                      ),
                      c(m.length)
                  }
  ...
  function V(e, t) {
    return (
      (e.replace(b.cssComments, "").match(b.cssUrls) || []).forEach(function (
        r
      ) {
  ...
  function T() {
    return v && (window.performance || {}).now
